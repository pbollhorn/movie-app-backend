...
public class Movie {
    ...
    public void addCredit(String id, Person person, String department, String job, String character, Integer rankInMovie) {
        credits.add(new Credit(id, this, person, department, job, character, rankInMovie));
    }
