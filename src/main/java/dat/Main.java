...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (EntityManager em = emf.createEntityManager()) {
            ...
            em.createNativeQuery("ALTER DATABASE " + DB_NAME + " SET pg_trgm.similarity_threshold=0.3").executeUpdate();  // TODO: Delete this line
            em.createNativeQuery("ALTER DATABASE " + DB_NAME + " SET pg_trgm.word_similarity_threshold=0.6").executeUpdate(); // TODO: Delete this line
